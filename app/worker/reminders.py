...
REMINDER_MESSAGES = {
    "trial_expired": {
        1: "⏰ Твой пробный период закончился вчера. Перейди на Pro или Business чтобы продолжить получать заявки! 💰",
        3: "👋 Прошло 3 дня с окончания триала. На Free-тарифе ты получаешь 50 уведомлений/день — апни до Pro чтобы снять лимит.",
