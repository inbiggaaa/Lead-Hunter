...
TEXTS = {
    ...
    "mf_btn_correct": "✅ Correct",
    "mf_btn_error": "⚠️ Error",
    "mf_btn_uncertain": "🤷 Not sure",
    "mf_btn_back": "◀️ Back",
    "mf_btn_change": "✏️ Change",
    "mf_btn_confirm_done": "✅ Done",
    "mf_btn_catalog": "📚 Choose from catalog",
    "mf_btn_cat_missing": "➕ Category missing",
    "mf_btn_skip": "Skip",
    "mf_reason_wrong_category": "📂 Wrong category",
    "mf_reason_provider_offer": "📢 Ad / offer",
    "mf_reason_job_vacancy": "💼 Job vacancy",
    "mf_reason_job_search": "🙋 Job search",
    "mf_reason_social_request": "👥 Non-commercial request",
    "mf_reason_discussion_news": "📰 Discussion / news",
    "mf_reason_wrong_geography": "📍 Wrong geography",
    "mf_reason_duplicate": "🔁 Duplicate",
    "mf_reason_other": "❓ Other",
    "mf_saved": "Rating saved",
    "mf_saved_summary": "Rating: {verdict}\nReason: {reason}\nConfirmed: {confirmed}\nExpected category: {expected}",
    "mf_summary_label": "📋 {label}",
    "mf_stale": "This rating is no longer available",
    "mf_closed": "Labeling is currently unavailable",
    "mf_invalid": "Invalid action",
    "mf_need_segment": "Select at least one category",
