...
TEXTS = {
    ...
    "plan_card_business": (
        ...
        "• безлимит направлений · 20 стран · города без лимита\n"
    ...
    "btn_messages": "📨 Сервисные сообщения",
    "messages_title": "📨 Сервисные сообщения",
    "messages_body": (
        "Можно отключить маркетинговые сообщения Free-цикла:\n"
        "• дневные отчёты о заявках (дни 0/3/7/14)\n"
        "• разовое предложение со скидкой (день 30)\n\n"
        "Нельзя отключить: оплату, окончание доступа, напоминания о продлении."
    ),
    "messages_status_on": "Сейчас: маркетинговые сообщения <b>включены</b>.",
    "messages_status_off": "Сейчас: маркетинговые сообщения <b>отключены</b>.",
    "messages_btn_disable": "🔕 Отключить маркетинговые",
    "messages_btn_enable": "🔔 Включить маркетинговые",
    ...
    "mf_btn_correct": "✅ Верно",
    "mf_btn_error": "⚠️ Ошибка",
    "mf_btn_uncertain": "🤷 Не уверен",
    "mf_btn_back": "◀️ Назад",
    "mf_btn_change": "✏️ Изменить",
    "mf_btn_confirm_done": "✅ Готово",
    "mf_btn_catalog": "📚 Выбрать из каталога",
    "mf_btn_cat_missing": "➕ Категории нет",
    "mf_btn_skip": "Пропустить",
    "mf_reason_wrong_category": "📂 Не та категория",
    "mf_reason_provider_offer": "📢 Реклама / предложение",
    "mf_reason_job_vacancy": "💼 Вакансия",
    "mf_reason_job_search": "🙋 Поиск работы",
    "mf_reason_social_request": "👥 Некоммерческий запрос",
    "mf_reason_discussion_news": "📰 Обсуждение / новость",
    "mf_reason_wrong_geography": "📍 Не та география",
    "mf_reason_duplicate": "🔁 Дубликат",
    "mf_reason_other": "❓ Другое",
    "mf_saved": "Оценка сохранена",
    "mf_saved_summary": "Оценка: {verdict}\nПричина: {reason}\nПодтверждено: {confirmed}\nОжидаемая категория: {expected}",
    "mf_summary_label": "📋 {label}",
    "mf_stale": "Эта оценка больше недоступна",
    "mf_closed": "Разметка сейчас недоступна",
    "mf_invalid": "Некорректное действие",
    "mf_need_segment": "Выберите хотя бы одну категорию",
