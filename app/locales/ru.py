...
TEXTS = {
    ...
    "welcome_body": (
        ...
        "Первые 5 дней доступен Business-тариф: контакты, ссылки на чат и уведомления без лимита."
    ),
    ...
    "about_body": ("ℹ️ <b>LeadHunter</b>\n\n"
        ...
        "🆓 Первый поиск запускает 5 дней Business бесплатно"),
    ...
    "referral_body": ("🎁 <b>Пригласи друга</b>\n\n"
        ...
        "Ты получишь +{bonus} дней к активной подписке после первой оплаты друга.\n\n"
