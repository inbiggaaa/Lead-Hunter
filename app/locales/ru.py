...
TEXTS = {
    ...
    "channel_private_pending": "⏳  выглядит приватным. Канал отправлен на проверку; мы сообщим после одобрения.",
    ...
    "trial_started": "🎉 Поиск запущен! Открыт пробный период Business на {days} дней.",
