...
TEXTS = {
    ...
    "welcome_body": (
        "<b>Lead Hunter AI — мониторинг клиентских заявок в Telegram</b>\n\n"
        "Сервис в реальном времени отслеживает публичные Telegram-каналы "
        "и выявляет сообщения потенциальных клиентов по вашему направлению "
        ...
        "Доступен бесплатный период — 5 дней тарифа Business.\n\n"
