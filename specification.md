...
## 2. Тарифная матрица v2.1 + Business v2.2 (#89, 24.07.2026)
...
| География | 1 страна, города ∞ | 1 страна, города ∞ | до 3 стран, города ∞ | до 20 стран, города ∞ |
...
| Regex | — | — | отложено (нет UI в боте) | отложено |
