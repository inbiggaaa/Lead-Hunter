...
Статус: **🛠 ВЕТКА `feature/codex-userflow-v2`: внедряется тарифная матрица v2.1 и новый user flow. Прод пока работает на ранее задеплоенной v2. Новая матрица: Start 1 направление/1 страна/города без лимита/3 фразы; Pro 3 направления/3 страны/города без лимита/20 фраз; Business 12 направлений/9 стран/города без отдельного лимита/50 фраз/50 каналов. Уведомления без лимита на всех планах.**
