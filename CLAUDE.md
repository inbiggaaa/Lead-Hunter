...
Фаза 0 (8/8) + 1.6/1.1/1.2/1.3/1.4 + 2.2 done. Три hotfix'а из живого прогона (пагинация, notify_admin, alert-dedup) применены в main.
Режим: пассивный мониторинг через @leadhunterai_admin.
ОСТАЛОСЬ (штатно, без аврала): 1.5 (активация страны), 1.7 (dead-man switch), 1.8 (дубли городов),
