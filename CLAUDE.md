...
| География | 1 страна, 1 город | 1 страна, 1 город | до 3 стран, до 9 distinct-городов | до 9 стран, города без отдельного лимита |
...
Статус: **🛠 ВЕТКА `feature/codex-userflow-v2`: внедряется тарифная матрица v2.1 и новый user flow. Прод пока работает на ранее задеплоенной v2. Новая матрица: Start 1 направление/1 страна/1 город/3 фразы; Pro 3 направления/3 страны/9 distinct-городов/20 фраз; Business 12 направлений/9 стран/города без отдельного лимита/50 фраз/50 каналов. Уведомления без лимита на всех планах.**
...
**ПАМЯТЬ USERFLOW (14.07.2026):** U0 завершена в `feature/codex-userflow-v2`. После завершения базового userflow обязательно напомнить владельцу перейти к отдельному этапу: маркетинговые тексты и функционал, уведомления об окончании подписки, стимулы renewal и механики повторной подписки. До этого этапа не добавлять новые маркетинговые обещания.
...
| 82 | Тарифы v2.1 (14.07.2026): уведомления остаются без лимита. Старт : 1 направление, 1 страна, 1 город, 3 ключевые фразы, 1 свой канал. Профи : до 3 направлений, 3 стран, 9 distinct-городов суммарно, 20 фраз, 10 каналов. Бизнес : до 12 направлений, 9 стран, города без отдельного лимита в этих странах, 50 фраз и 50 каналов. Trial повторяет Business. Runtime-источник истины: app/config.py + crud._plan_limits(). |
