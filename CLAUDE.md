...
### Тарифы (v2.1 + Business v2.2 #89 — 24.07.2026)
...
| Направления (подкатегории) | 1 | 1 | 3 | безлимит |
| География | 1 страна, города без лимита | 1 страна, города без лимита | до 3 стран, города без лимита | до 20 стран, города без лимита |
...
| 82 | Тарифы v2.1 (14.07.2026): уведомления остаются без лимита. Старт: 1 направление, 1 страна, города без лимита, 3 ключевые фразы, 1 свой канал. Профи: до 3 направлений, 3 стран, города без лимита, 20 фраз, 10 каналов. Бизнес: до 12 направлений, 9 стран (широта Business заменена #89), 50 фраз и 50 каналов. Trial повторяет Pro (часть решения заменена #85). Runtime-источник истины: app/config.py + crud._plan_limits(). |
| 89 | Business v2.2 (24.07.2026): безлимит направлений, до 20 стран, города без лимита; keywords/каналы 50. Заменяет широту Business из #82. |
