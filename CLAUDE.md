...
Статус: **прод на `main` = фазы A+B fable_core_plan (деплой 12.07 14:10 MSK, тег core-phase-ab-live; утром того же дня — аудит, тег audit-fixes-live). Активный план — fable_core_plan.md: 0.1/0.2/A1-A3/B1/B4-B6 [x]; B2 (few-shot) — следующий заход; B3 ждёт разметки владельца (docs/eval/recall_template_2026-07-12.md); 0.3 baseline v2 ~19–22.07; снапшот латентности ~15.07. ОТЛОЖЕНО: тест сценария Б (канал в Cold-тире, keyword «фотограф» загружен), Sentry, TLS админки, разбор 85 bulk-каналов (лимит владельца 85/60).**
