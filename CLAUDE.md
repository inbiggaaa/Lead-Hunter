...
Фаза: **Фаза 3 (inline-кнопки, FSM-навигация)** ⏳

Сделано: Фазы 0-2 завершены. БД: 20 таблиц, Alembic-миграции обратимы, seed (5 стран, 17 городов, 29 сегментов, 85 keywords), 16 unit-тестов проходят, индекс idx_user_sub_lookup.

Следующее: inline-клавиатуры, FSM-воронка, управление словами/каналами.
