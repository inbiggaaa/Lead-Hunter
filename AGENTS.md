...
Статус: **DECISIONS #89 — Business: безлимит направлений + до 20 стран (города без лимита).** Runtime defaults + locales + docs обновлены; focused pytest 32 passed. Prod bot restart / правки прод-`.env` — только по команде. Segment-aware LLM на main остаётся OFF.
